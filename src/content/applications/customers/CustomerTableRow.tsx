import {  IconButton, TableBody, TableCell, TableRow, Tooltip, Typography, useTheme } from "@mui/material";
...
const CustomerTableRow =({data =[], selectedCryptoOrders =[],handleSelect}:Props) =>{

...
const applyFilters = (categoryList: ICategoryProps[], filters: Filters): ICategoryProps[] => {
...
const CategoryTable: FC<RecentOrdersTableProps> = ({ categoryList }) => {
  ...
  const handleSelectAllCryptoOrders = (
    ...
    setSelectedCryptoOrders(
      event.target.checked
        ? categoryList.map((cryptoOrder) => cryptoOrder.id)
        : []
    );
  };
  ...
  const selectedSomeCryptoOrders =
    ...
    selectedCryptoOrders.length < categoryList.length;
